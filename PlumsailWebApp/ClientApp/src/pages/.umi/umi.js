...
import findRoute, {
  getUrlQuery,
} from 'C:/Users/VIsaev/RiderProjects/PlumsailWebApp/PlumsailWebApp/ClientApp/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path:
        'C:/Users/VIsaev/RiderProjects/PlumsailWebApp/PlumsailWebApp/ClientApp',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
